...
public class WorldGenTreesRocky extends WorldGenAbstractTree
{
    private IBlockState blockStateWood = ModBlocks.STONE_LOG.getDefaultState();
    private IBlockState blockStateLeaves = ModBlocks.PEBBLE_LEAVES.getDefaultState().withProperty(BlockLeaves.CHECK_DECAY, Boolean.valueOf(false));
     ...
     */
    public WorldGenTreesRocky(boolean parShouldNotify)
    {
