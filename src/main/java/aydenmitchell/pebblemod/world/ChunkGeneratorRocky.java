...
public class ChunkGeneratorRocky implements IChunkGenerator
{
    ...
    protected Biome biome = ModBiomes.rocky;
    protected IBlockState baseBlock = Blocks.STONE.getDefaultState();
    ...
    protected MapGenVillageRocky villageGenerator = new MapGenVillageRocky();
     ...
     */
    public ChunkGeneratorRocky(World worldIn)
    {
        // DEBUG
        ...
        MapGenVillage.VILLAGE_SPAWN_BIOMES.add(ModBiomes.rocky);
    ...
    protected void postTerrainGenEvents()
    {
        ...
        villageGenerator = (MapGenVillageRocky) TerrainGen.getModdedMapGen(villageGenerator, InitMapGenEvent.EventType.VILLAGE);
