...
public class MapGenVillageRocky extends MapGenStructure
{
    /** A list of all the biomes villages can spawn in. */
    public static List<Biome> VILLAGE_SPAWN_BIOMES = Arrays.<Biome>asList(ModBiomes.rocky);
    /** None */
    private int size;
     ...
     * @param map the map
     */
    public MapGenVillageRocky(Map<String, String> map)
    {
        this();
    ...
    {
        return new MapGenVillageRocky.Start(world, rand, chunkX, chunkZ, size);
    }
