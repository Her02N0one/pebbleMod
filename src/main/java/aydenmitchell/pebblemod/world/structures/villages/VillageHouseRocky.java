...
*/
package aydenmitchell.pebblemod.world.structures.villages;
...
public class VillageHouseRocky extends StructureVillagePieces.Village
{
    
    /**
     * Instantiates a new village house cloud.
     */
    public VillageHouseRocky()
    {
    }
     ...
     */
    public VillageHouseRocky(StructureVillagePieces.Start parStart, int parType, Random parRand, StructureBoundingBox parStructBB, EnumFacing parFacing)
    {
    ...
    public boolean addComponentParts(World parWorld, Random parRand, StructureBoundingBox parStructBB)
    {
        ...
        IBlockState wallBlockState = getBiomeSpecificBlockState(Blocks.STONEBRICK.getDefaultState());
        IBlockState stateStairsNorth = getBiomeSpecificBlockState(Blocks.STONE_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.NORTH));
        IBlockState stateStairsSouth = getBiomeSpecificBlockState(Blocks.STONE_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.SOUTH));
        IBlockState stateStairsEast = getBiomeSpecificBlockState(Blocks.STONE_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.EAST));
        IBlockState stateStairsWest = getBiomeSpecificBlockState(Blocks.STONE_STAIRS.getDefaultState().withProperty(BlockStairs.FACING, EnumFacing.WEST));
        IBlockState statePlanks = getBiomeSpecificBlockState(Blocks.STONE.getDefaultState());
        IBlockState stateLog = getBiomeSpecificBlockState(ModBlocks.STONE_LOG.getDefaultState());
