...
public class ModItems {
	...
	//Material
	public static final ArmorMaterial TOOL_PEBBLE = EnumHelper.addArmorMaterial("armor_pebble", Reference.MOD_ID + ":pebble", 5, new int[]{1, 2, 3, 1}, 15, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 0.0F);
...
//	public static final Item FOSSIL = new ItemBase("fossil");
	...
	//Armor
	public static final Item HELMET_PEBBLE = new ArmorBase("helmet_pebble");
